...
delete from catalog_eav_attribute where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_amount_per_itr');
delete from `eav_entity_attribute` where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_amount_per_itr');
delete from eav_attribute where attribute_code = 'litle_subs_amount_per_itr';
delete from catalog_eav_attribute where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_num_of_itrs');
delete from `eav_entity_attribute` where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_num_of_itrs');
delete from eav_attribute where attribute_code = 'litle_subs_num_of_itrs';
delete from catalog_eav_attribute where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_itr_len');
delete from `eav_entity_attribute` where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_itr_len');
delete from eav_attribute where attribute_code = 'litle_subs_itr_len';
delete from catalog_eav_attribute where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_days_for_trial');
delete from `eav_entity_attribute` where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_days_for_trial');
delete from eav_attribute where attribute_code = 'litle_subs_days_for_trial';
delete from catalog_eav_attribute where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_itr_len');
delete from `eav_entity_attribute` where attribute_id = (select attribute_id from eav_attribute where attribute_code = 'litle_subs_itr_len');
delete from eav_attribute where attribute_code = 'litle_subs_itr_len';
